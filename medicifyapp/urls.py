...
urlpatterns = [
    ...
    path('submit_for_service', views.submit_for_service, name='submit_for_service'),
    path('request_for_service/<int:pk>', views.request_for_service, name='request_for_service'),
